...
#plot(x=1,type="n",xlim=c(0,400),ylim=c(min(df[,2:17],na.rm=T),max(df[,2:17],na.rm=T)),main=main,ylab=ylab,xlab="search radius")
plot(x=1,type="n",xlim=c(0,400),ylim=c(0,175000),main=main,ylab=ylab,xlab="search radius")
...
names(df) <- c("geoms",Llist)
plot(x=1,type="n",xlim=c(0,400),ylim=c(0,6000000),main=main,ylab=ylab,xlab="search radius")
legend("topright",lty=1,legend = geomdf$geoms,col=as.character(geomdf$col),ncol=3)
for (g in geoms){
try(lines(x=Llist,y=df[df$geoms == as.character(g),2:ncol(df)],col=as.character(geomdf[geomdf$geoms==as.character(g),"col"])))
}
...
names(df) <- c("geoms",Llist)
plot(x=1,type="n",xlim=c(0,400),ylim=c(0,450),main=main,ylab=ylab,xlab="search radius")
legend("topright",lty=1,legend = geomdf$geoms,col=as.character(geomdf$col),ncol=3)
for (g in geoms){
try(lines(x=Llist,y=df[df$geoms == as.character(g),2:ncol(df)],col=as.character(geomdf[geomdf$geoms==as.character(g),"col"])))
}
...
names(df) <- c("geoms",Llist)
plot(x=1,type="n",xlim=c(0,400),ylim=c(0,50000),main=main,ylab=ylab,xlab="search radius")
legend("topright",lty=1,legend = geomdf$geoms,col=as.character(geomdf$col),ncol=3)
for (g in geoms){
try(lines(x=Llist,y=df[df$geoms == as.character(g),2:ncol(df)],col=as.character(geomdf[geomdf$geoms==as.character(g),"col"])))
}
...
names(df) <- c("geoms",Llist)
plot(x=1,type="n",xlim=c(0,400),ylim=c(0,2),main=main,ylab=ylab,xlab="search radius")
legend("topright",lty=1,legend = geomdf$geoms,col=as.character(geomdf$col),ncol=3)
for (g in geoms){
try(lines(x=Llist,y=df[df$geoms == as.character(g),2:ncol(df)],col=as.character(geomdf[geomdf$geoms==as.character(g),"col"])))
}
...
names(df) <- c("geoms",Llist)
plot(x=1,type="n",xlim=c(0,400),ylim=c(0,1.6),main=main,ylab=ylab,xlab="search radius")
legend("topright",lty=1,legend = geomdf$geoms,col=as.character(geomdf$col),ncol=3)
for (g in geoms){
try(lines(x=Llist,y=df[df$geoms == as.character(g),2:ncol(df)],col=as.character(geomdf[geomdf$geoms==as.character(g),"col"])))
}
...
names(df) <- c("geoms",Llist)
plot(x=1,type="n",xlim=c(0,400),ylim=c(0,16),main=main,ylab=ylab,xlab="search radius")
legend("topright",lty=1,legend = geomdf$geoms,col=as.character(geomdf$col),ncol=3)
for (g in geoms){
try(lines(x=Llist,y=df[df$geoms == as.character(g),2:ncol(df)],col=as.character(geomdf[geomdf$geoms==as.character(g),"col"])))
}
...
names(df) <- c("geoms",Llist)
plot(x=1,type="n",xlim=c(0,400),ylim=c(0,50),main=main,ylab=ylab,xlab="search radius")
legend("topright",lty=1,legend = geomdf$geoms,col=as.character(geomdf$col),ncol=3)
for (g in geoms){
try(lines(x=Llist,y=df[df$geoms == as.character(g),2:ncol(df)],col=as.character(geomdf[geomdf$geoms==as.character(g),"col"])))
}
...
```{r,echo=F}
load(paste(folder,"/result_dfs_flatness1.RData",sep=""))
plot(x=1,type="n",xlim=c(0,400),ylim=c(0,2),main="Diversity indices")
